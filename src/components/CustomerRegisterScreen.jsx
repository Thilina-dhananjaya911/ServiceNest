...
import { User, MapPin, Mail, Phone, CreditCard, Lock, Eye, EyeOff, UserPlus, ArrowLeft, AlertCircle } from 'lucide-react';
import FileUpload from './FileUpload';
import logoImg from '../assets/logo.png';

export default function CustomerRegisterScreen({ onCustomerSubmit, setCurrentView }) {
  ...
  const validate = () => {
    ...
    if (!formData.nicNo.trim()) {
      ...
      newErrors.nicNo = 'Please enter a valid NIC number (e.g. 199012345678 or 901234567V).';
    }

    if (!nicPhoto) {
      newErrors.nicPhoto = 'NIC photo document is required for identity verification.';
    }
    ...
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Create your ServiceNest customer account to book verified local services
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5" noValidate>
        ...
        {/* Address */}
        <div>
          <label htmlFor="address" className="block text-xs font-semibold text-slate-700 uppercase tracking-wide mb-1.5">
            <span className="text-rose-500 mr-1">*</span>Address
          </label>
          <div className="relative">
